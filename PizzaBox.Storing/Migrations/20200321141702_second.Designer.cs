...
namespace PizzaBox.Storing.Migrations
{
    ...
    [Migration("20200321141702_second")]
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.Crust", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CrustId = 637203790220629861L,
                            Name = "Thin Crust",
                            Price = 2.00m
                        },
                        new
                        {
                            CrustId = 637203790220651509L,
                            Name = "Deep Dish",
                            Price = 4.00m
                        },
                        new
                        {
                            CrustId = 637203790220651573L,
                            Name = "New York Style",
                            Price = 3.00m
                        });
                });
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.Size", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SizeId = 637203790220664238L,
                            Name = "Large",
                            Price = 12.00m
                        },
                        new
                        {
                            SizeId = 637203790220664671L,
                            Name = "Medium",
                            Price = 10.00m
                        },
                        new
                        {
                            SizeId = 637203790220664694L,
                            Name = "Small",
                            Price = 8.00m
                        });
                });
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.Topping", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ToppingId = 637203790220665570L,
                            Name = "Cheese",
                            Price = 0.25m
                        },
                        new
                        {
                            ToppingId = 637203790220665891L,
                            Name = "Pepperoni",
                            Price = 0.50m
                        },
                        new
                        {
                            ToppingId = 637203790220665919L,
                            Name = "Tomato Sauce",
                            Price = 0.75m
                        });
                });
